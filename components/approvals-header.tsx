...
export function ApprovalsHeader() {
  ...
  return (
    <div className="space-y-4" style={{ fontFamily: "'Inter', sans-serif" }}>
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold text-gray-200">Approval Requests</h1>
        <div className="flex items-center gap-4">
          <Badge variant="secondary" className="bg-yellow-900/20 text-yellow-400 border-yellow-900/30">
            <AlertCircle className="h-3 w-3 mr-1 hover:rotate-6 transition-transform duration-200" />
            {pendingCount} Pending
          </Badge>
          <Badge variant="secondary" className="bg-green-900/20 text-green-400 border-green-900/30">
            <CheckCircle className="h-3 w-3 mr-1 hover:rotate-6 transition-transform duration-200" />
            {approvedCount} Approved
          </Badge>
          <Badge variant="secondary" className="bg-red-900/20 text-red-400 border-red-900/30">
            <XCircle className="h-3 w-3 mr-1 hover:rotate-6 transition-transform duration-200" />
            {rejectedCount} Rejected
          </Badge>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        <Select defaultValue="all">
          ...
          <SelectContent className="bg-neutral-900 border-yellow-900/30 text-gray-200">
            <SelectItem value="all" className="hover:bg-yellow-900/20">All Requests</SelectItem>
            <SelectItem value="pending" className="hover:bg-yellow-900/20">Pending Only</SelectItem>
        ...
        <Select defaultValue="all-amount">
          ...
          <SelectContent className="bg-neutral-900 border-yellow-900/30 text-gray-200">
            <SelectItem value="all-amount" className="hover:bg-yellow-900/20">All Amounts</SelectItem>
            <SelectItem value="over-2m" className="hover:bg-yellow-900/20">Over $2M</SelectItem>
            <SelectItem value="over-5m" className="hover:bg-yellow-900/20">Over $5M</SelectItem>
          </SelectContent>
        </Select>
      </div>
    </div>
