            ...
            <CardHeader className="pb-3">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between">
                <div className="flex items-center space-x-3 mb-2 sm:mb-0">
                  ...
                  <div>
                    <CardTitle className="text-lg text-gray-900 dark:text-white truncate">{customer.name}</CardTitle>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="flex items-center text-sm text-gray-600 dark:text-gray-400">
                  ...
                  {t("lastContact")}: <span className="truncate ml-1">{new Date(customer.lastContact).toLocaleDateString()}</span>
                </div>
              </div>
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-center">
                  ...
                  <div>
                    <div className="text-chart-1 font-bold dark:text-green-400">
