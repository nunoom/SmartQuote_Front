...
import { Eye, EyeOff, Loader2, Mail, Lock, User, Zap, ChevronRight, Sparkles, ArrowLeft, Home } from "lucide-react"
import { ThemeToggle } from "@/components/theme-toggle"
import { LanguageSwitcher } from "@/components/language-switcher"
import { IconEye, IconEyeOff, IconLoader2, IconSparkles } from "@tabler/icons-react"
      ...
      <div className="relative z-10 w-full max-w-md">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4">
              ...
              <ul className="text-xs text-blue-700 dark:text-blue-400 space-y-1">
                <li className="flex items-center gap-2">
                  <div className={`w-2 h-2 rounded-full ${password.length >= 6 ? 'bg-green-500' : 'bg-blue-400'}`}></div>
                  {t("minimum6Characters")}
                </li>
                <li className="flex items-center gap-2">
                  <div className={`w-2 h-2 rounded-full ${password && confirmPassword && password === confirmPassword ? 'bg-green-500' : 'bg-blue-400'}`}></div>
        ...
        <div className="text-center mt-8">
          <p className="text-xs text-gray-500 dark:text-gray-400">
            © 2025 SmartQuote • {t("projectDeveloped")}
          </p>
        </div>
      </div>
    </div>
