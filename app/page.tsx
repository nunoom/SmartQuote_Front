...
export default function SmartQuoteLandingPage() {
  ...
  const flowSteps = [
    {
      ...
      color: "bg-gray-800 border-yellow-900"
    },
    {
      step: "02", 
  ...
  return (
    <div className="min-h-screen bg-black overflow-x-hidden">
      ...
      <header className="border-b border-gray-700 bg-black/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div className="h-10 w-10 bg-gradient-to-br from-yellow-600 to-yellow-400 rounded-lg flex items-center justify-center">
          ...
          <div className="hidden md:flex items-center gap-6">
            <nav className="flex items-center gap-6">
              <a href="#problema" className="text-gray-400 hover:text-yellow-400 transition-colors">Problema</a>
              <a href="#solucao" className="text-gray-400 hover:text-yellow-400 transition-colors">Solução</a>
              <a href="#funcionamento" className="text-gray-400 hover:text-yellow-400 transition-colors">Como Funciona</a>
              <a href="#beneficios" className="text-gray-400 hover:text-yellow-400 transition-colors">Benefícios</a>
            </nav>
            <Link href="/login">
            <button className="bg-gradient-to-r from-yellow-600 to-yellow-400 text-black px-6 py-2 rounded-lg hover:shadow-lg transition-shadow">
              Entrar
            </button>
            </Link>
          </div>
          ...
          <button
            ...
            onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
          >
            {isMobileMenuOpen ? <X className="h-6 w-6 text-gray-400" /> : <Menu className="h-6 w-6 text-gray-400" />}
          </button>
        </div>
          ...
          <div className="md:hidden absolute top-full left-0 right-0 bg-black border-b border-gray-700 shadow-lg">
            <div className="container mx-auto px-4 py-4 space-y-4">
              <nav className="flex flex-col gap-4">
                <a href="#problema" className="text-gray-400 hover:text-yellow-400 transition-colors" onClick={() => setIsMobileMenuOpen(false)}>Problema</a>
                <a href="#solucao" className="text-gray-400 hover:text-yellow-400 transition-colors" onClick={() => setIsMobileMenuOpen(false)}>Solução</a>
                <a href="#funcionamento" className="text-gray-400 hover:text-yellow-400 transition-colors" onClick={() => setIsMobileMenuOpen(false)}>Como Funciona</a>
                <a href="#beneficios" className="text-gray-400 hover:text-yellow-400 transition-colors" onClick={() => setIsMobileMenuOpen(false)}>Benefícios</a>
              </nav>
              <Link href="/login">

              <button className="w-full bg-gradient-to-r from-yellow-600 to-yellow-400 text-black px-6 py-2 rounded-lg hover:shadow-lg transition-shadow">
                Entrar
              </button>
              </Link>
            </div>
      ...
      {/* Hero Section */}
      <section className="relative py-20 px-4 bg-gradient-to-br from-gray-900 via-gray-800 to-black overflow-hidden">
        ...
        <div className="relative container mx-auto text-center max-w-5xl">
          <div className="mb-8">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-yellow-600 to-yellow-400 text-black px-4 py-2 rounded-full text-sm font-medium mb-6">
              <Star className="h-4 w-4" />
              Projeto SmartQuote - Apresentação Oficial
            </div>
            <h1 className="text-5xl md:text-7xl font-bold text-gray-200 mb-6 leading-tight">
              Smart<span className="bg-gradient-to-r from-yellow-600 to-yellow-400 bg-clip-text text-transparent">Quote</span>
            </h1>
          ...
          <div className="bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-gray-700 mb-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-gradient-to-r from-yellow-600 to-yellow-400 text-black px-8 py-4 rounded-xl text-lg font-semibold hover:shadow-lg transition-all transform hover:scale-105">
              Descubra o Futuro das Cotações
              <ChevronRight className="inline ml-2 h-5 w-5" />
            </button>
            <button className="border-2 border-yellow-900 text-yellow-400 px-8 py-4 rounded-xl text-lg font-semibold hover:bg-yellow-900/20 transition-colors">
              Ver Demonstração
            </button>
          </div>
        </div>
      ...
      {/* Problema e Solução */}
      <section id="problema" className="py-20 px-4 bg-gray-900">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            {problems.map((problem, index) => (
              <div key={index} className="bg-gray-800 rounded-2xl p-6 shadow-lg border-l-4 border-yellow-600">
                <div className="flex items-center mb-4">
                  {problem.icon}
                  <h3 className="text-xl font-bold text-gray-200 ml-3">{problem.title}</h3>
                </div>
          ...
          <div className="text-center mb-16" id="solucao">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-yellow-600 to-yellow-400 rounded-full mb-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {solutions.map((solution, index) => (
              <div key={index} className="bg-gray-800 rounded-2xl p-6 shadow-lg border-l-4 border-yellow-400">
                <div className="flex items-center mb-4">
                  {solution.icon}
                  <h3 className="text-xl font-bold text-gray-200 ml-3">{solution.title}</h3>
                </div>
      ...
      <section id="funcionamento" className="py-20 px-4 bg-black">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="mb-16 p-8 bg-gradient-to-r from-gray-800 to-gray-900 rounded-2xl">
            <div className="flex flex-wrap justify-center items-center gap-4 text-center">
              <div className="bg-yellow-500 text-black px-4 py-2 rounded-lg font-semibold">Pedido</div>
              <ArrowRight className="h-6 w-6 text-gray-400" />
              <div className="bg-yellow-600 text-black px-4 py-2 rounded-lg font-semibold">IA</div>
              <ArrowRight className="h-6 w-6 text-gray-400" />
              <div className="bg-yellow-500 text-black px-4 py-2 rounded-lg font-semibold">Fornecedores</div>
              <ArrowRight className="h-6 w-6 text-gray-400" />
              <div className="bg-yellow-400 text-black px-4 py-2 rounded-lg font-semibold">Cotação</div>
              <ArrowRight className="h-6 w-6 text-gray-400" />
              <div className="bg-yellow-600 text-black px-4 py-2 rounded-lg font-semibold">Gestor</div>
              <ArrowRight className="h-6 w-6 text-gray-400" />
              <div className="bg-yellow-500 text-black px-4 py-2 rounded-lg font-semibold">Cliente</div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {flowSteps.map((step, index) => (
              <div key={index} className={`relative ${step.color} border-2 rounded-2xl p-6 hover:shadow-lg transition-shadow`}>
                <div className="absolute -top-4 -left-4 w-8 h-8 bg-gradient-to-br from-yellow-600 to-yellow-400 rounded-full flex items-center justify-center text-black font-bold text-sm">
                  {step.step}
                </div>
                <div className="flex items-center mb-4">
                  {step.icon}
                  <h3 className="text-xl font-bold text-gray-200 ml-4">{step.title}</h3>
                </div>
      ...
      <section className="py-20 px-4 bg-gray-900">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow border border-gray-700">
                <div className="flex items-center mb-4">
                  {feature.icon}
                  <h3 className="text-xl font-bold text-gray-200 ml-3">{feature.title}</h3>
                </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map((benefit, index) => (
              <div key={index} className="text-center bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 shadow-lg border border-gray-700">
                <div className="flex justify-center mb-4">
                  {benefit.icon}
                </div>
                <h3 className="text-xl font-bold text-gray-200 mb-3">{benefit.title}</h3>
                <p className="text-gray-400 mb-4 leading-relaxed">{benefit.description}</p>
                <div className="bg-gradient-to-r from-yellow-600 to-yellow-400 text-black px-4 py-2 rounded-full text-sm font-bold">
                  {benefit.metric}
                </div>
              </div>
            ))}
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-gray-900 via-yellow-900 to-gray-800 text-gray-200 relative overflow-hidden">
        ...
        <div className="relative container mx-auto text-center max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <button className="border-2 border-yellow-400 text-yellow-400 px-8 py-4 rounded-xl text-lg font-semibold hover:bg-yellow-900/20 transition-colors">
